...
public class WakeRecommendationPanel extends JPanel {
    private ScreenController controller;

    public WakeRecommendationPanel(ScreenController controller, WakeTime wakeTime) {
        this.controller = controller;
        setLayout(null);
        setBackground(new Color(91, 89, 153));

        // 백엔드에서 시간 받아오기
        String currentTime = wakeTime.getWakeTime().format(DateTimeFormatter.ofPattern("HH:mm"));
        List<String> recommendedTimes = wakeTime.recommendSleepTimes();
        ...
        try {
            // 정확한 리소스 경로 사용
            System.out.println("이미지 경로: " + getClass().getResource("/res/images/img.png"));  // ✅ 경로 확인용 로그
            ...
            // ✅ 홈 버튼 클릭 시 MainMenuPanel로 이동
            imgButton.addActionListener(e -> {
                Window window = SwingUtilities.getWindowAncestor(WakeRecommendationPanel.this);
        ...
        // 안내 문구
        JLabel desc = new JLabel("<html><div style='text-align:center;'>You should sleep at:<br>(1 cycle = 1.5hrs)</div></html>", SwingConstants.CENTER);
...
//        JFrame frame = new JFrame("Sleep Time Recommendation");
//        frame.setSize(1440, 1024);
//        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
//        frame.setLocationRelativeTo(null);
//
//        // 기상 시간 설정 예: "07:00"
//        WakeTime wakeTime = new WakeTime("07:00");
//        WakeRecommendationPanel panel = new WakeRecommendationPanel(wakeTime);
//
//        frame.add(panel);
