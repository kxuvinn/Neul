...
public class TodayPanel extends JPanel {
    ...
    public TodayPanel(ScreenController controller) {
        ...
        sleepPanel.setBounds(100, 200, 600, 550);
        ...
        sleepLabel.setFont(new Font("SansSerif", Font.PLAIN, 30));
        ...
        moodPanel.setBounds(740, 200, 600, 550);
        ...
        moodLabel.setFont(new Font("SansSerif", Font.PLAIN, 30));
        ...
        saveBtn.setBounds(637, 800, 166, 50);
